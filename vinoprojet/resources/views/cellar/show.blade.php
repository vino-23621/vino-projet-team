    ...
    <div class="dualPanel filter-sidebar">
        <div class="dualPanel-left">
            ...
            <section id="filtre-nav">
                ...
                <input id="trier_id" class="filtre-nav" type="checkbox">
            </section>
            ...
            <div class="grid-card">
                ...
                <article class="card-bottle">
                    ...
                    <div class="card-bottle-content">
                        ...
                        <form action="{{ route('cellars.updateQuantity', ['cellar' => $cellar->id, 'bottle' => $bottle->id]) }}"
                        ...
                        <button class="openModalBtnBottle modalBtn" data-id="{{ $bottle->id }}" data-cellar="{{ $cellar->id }}">
                            <i class="fa-regular fa-trash-can"></i> Retirer la bouteille
                        </button>
