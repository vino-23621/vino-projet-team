    ...
    <div class="dualPanel-left">
        <div class="dual-panel-left-header">
            ...
            <p class="profile-subtitle">
                Crée un ou plusieurs celliers pour organiser tes bouteilles.
            </p>
        </div>
    </div>
    ...
    <div class="dualPanel-right">
        ...
        <div class="dual-panel-right-header">
            <div class="cta-banner">
                ...
                <a href="{{ route('catalog.index', ['cellar_id' => $cellar->id]) }}" class="button button__safe">
                    Ajouter
                </a>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="modalUser">
                            <div class="modalUser-box">
                                ...
                                <div>
                                    <form action="{{ route('cellars.removeBottle', ['cellar' => $cellar->id, 'bottle' => $bottle->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="button button__danger">Supprimer</button>
                                    </form>
                                    <label for="deleteModal-{{ $bottle->id }}" class="button button__safe">
                                        Annuler
                                    </label>
                                </div>
                            </div>
